	...
	*/
	...
	public function get_image_thumbnail(){
		...
		if ( has_post_thumbnail() ) :
			...
			if ( is_singular() )
			{
				$html  .=  '<a href="'.esc_url( $post_thumbnail_url ).'" class="image-popup gallery-image thickbox">';
			} else
			{
				$html  .= '<a href="'.esc_url( get_permalink() ).'" class="image-link gallery-image">';
			}
...
$grocery_store_post_related = new Grocery_Store_Post_Related();